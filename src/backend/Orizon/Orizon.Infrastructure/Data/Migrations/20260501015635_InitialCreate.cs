...
namespace Orizon.Infrastructure.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "briefing_entries",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    Date = table.Column<DateOnly>(type: "date", nullable: false),
                    EmailSummaryJson = table.Column<string>(type: "jsonb", nullable: true),
                    CalendarEventsJson = table.Column<string>(type: "jsonb", nullable: true),
                    TrelloTasksJson = table.Column<string>(type: "jsonb", nullable: true),
                    WeatherJson = table.Column<string>(type: "jsonb", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_briefing_entries", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "trello_board_configs",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    BoardId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    BoardName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    BoardColor = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    TodayListId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    InProgressListId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    TodayListName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    InProgressListName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_trello_board_configs", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_briefing_entries_UserId_Date",
                table: "briefing_entries",
                columns: new[] { "UserId", "Date" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_trello_board_configs_UserId_BoardId",
