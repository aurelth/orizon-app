...
namespace Orizon.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260515181902_AddHasCompletedOnboardingToIdentityUser")]
    partial class AddHasCompletedOnboardingToIdentityUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Orizon.Domain.Entities.AppUser", b =>
                {
                    ...
                    b.Property<double?>("TravelLatitude")
                        .HasColumnType("double precision");

                    b.Property<string>("TravelLocationName")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Orizon.Domain.Entities.BriefingEntry", b =>
                {
                    ...
                    b.Property<string>("EmailSummaryJson")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<string>("TrelloTasksJson")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Orizon.Domain.Entities.TrelloBoardConfig", b =>
                {
                    ...
                    b.Property<string>("InProgressListId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");

                    b.Property<string>("InProgressListName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.Property<string>("TodayListId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");

                    b.Property<string>("TodayListName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.ToTable("trello_board_configs", (string)null);
                });

            modelBuilder.Entity("Orizon.Infrastructure.Identity.AppIdentityUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Orizon.Infrastructure.Identity.AppIdentityUser", null)
                        .WithMany()
